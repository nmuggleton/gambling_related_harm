...
stargazer(m1, m2, m3, m4, m5, 
          ...
          out = "tables/regression_gamblers_only_a4.tex")
...
stargazer(m1, m2, m3, m4, m5, 
          ...
          dep.var.caption = "Outcome at $t=1$",
          out = "tables/regression_gamblers_only_a5.tex")
...
stargazer(m1, m2, m3, m4, m5, 
          ...
          dep.var.labels = c("Insurance", "Mortgage", "Savings", "ISA", 
                             "Pension"),
          dep.var.caption = "Outcome at $t=1$",
          out = "tables/regression_gamblers_only_a6.tex")
...
stargazer(m1, m2, m3, m4, m5, 
          ...
          dep.var.labels = c("Fast food", "Gaming", "Bars", "Tobacco", 
                             "Off licences"),
          dep.var.caption = "Outcome at $t=1$",
          out = "tables/regression_gamblers_only_a7.tex")
...
stargazer(m1, m2, m3, m4,
          ...
          dep.var.labels = c("Prescriptions", "Self-care", "Fitness",
                             "Nights awake"),
          dep.var.caption = "Outcome at $t=1$",
          out = "tables/regression_gamblers_only_a8.tex")
...
stargazer(m1, m2, m3, m4,
          ...
          dep.var.labels = c("Hobbies", "Social activities", "Education",
                             "Travel"),
          dep.var.caption = "Outcome at $t=1$",
          out = "tables/regression_gamblers_only_a9.tex")
...
stargazer(m1, m2,
          ...
          dep.var.caption = "Outcome at $t=1$",
          out = "tables/regression_gamblers_only_a10.tex")
